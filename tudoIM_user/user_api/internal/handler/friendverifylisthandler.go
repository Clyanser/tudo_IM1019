...
func FriendVerifyListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewFriendVerifyListLogic(r.Context(), svcCtx)
		resp, err := l.FriendVerifyList(&req)
		// if err != nil {
